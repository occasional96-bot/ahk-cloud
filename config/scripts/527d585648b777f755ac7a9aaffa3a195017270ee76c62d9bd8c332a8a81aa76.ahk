...
;
;  Ctrl+Alt+J (1.29.0): the same three cells as a floating strip AT THE MOUSE, for
;  when ERA's titlebar (and so the dock) is buried. Closes on: Ctrl+Alt+J again,
;  Esc, any cell click, or clicking anywhere else (focus loss). See CurStrip*.
; ============================================================================
#NoEnv
