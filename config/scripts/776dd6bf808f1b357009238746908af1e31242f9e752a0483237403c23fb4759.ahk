...
global CfgHideReceipted  := 1     ; the only column hidden by default (Kaine, 2026-07-22) -
                                  ; St / Invoice / Make / Order / Date / Ex GST / Po-Inv all
                                  ; draw; the Receipted stamp does not
...
ReadConfig() {
    ...
    IniRead, CfgHideReceipted,   %ini%, settings, HideColReceipted, 1
