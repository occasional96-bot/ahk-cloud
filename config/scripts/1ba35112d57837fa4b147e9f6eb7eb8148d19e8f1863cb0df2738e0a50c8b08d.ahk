...
ExportOnly(eraQuery, csvName) {
    ...
    ; Snapshot pre-export modification times
    preTimes := []
    for i, p in paths
    ...
    ; File Import Monitor may appear while ERA exports
    ...
    if (csvFile == "")
    {
        ...
        return Fail(
        "CSV not updated within 60s (export may have failed):`n"
        . pathList
        )
    }
...
ERA_Activate() {
    ...
    ControlGet, hCtl, Hwnd,,
        Afx:10000000:b:00010003:00000000:000000001,
        ahk_id %hWnd%

    if (!hCtl)
    {
        ControlGet, hCtl, Hwnd,,
            Afx:10000000:b:00010005:00000000:000000001,
            ahk_id %hWnd%
    }
