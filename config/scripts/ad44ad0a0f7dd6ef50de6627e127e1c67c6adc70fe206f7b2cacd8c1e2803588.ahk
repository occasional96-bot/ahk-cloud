...
BuildGui:
    ...
    if (A_PtrSize != 8) {
        GuiControl, , DropHint, % "32-bit AHK: drag disabled. Use Add files / Grab / Paste, then Send all."
...
; --- POST JSON via WinHTTP (synchronous). Returns {status, text}.
