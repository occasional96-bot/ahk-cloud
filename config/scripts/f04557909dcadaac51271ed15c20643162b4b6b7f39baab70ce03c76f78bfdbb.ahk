...
Menu, MyMenu, Add, RoadWorthy Vehicle - Shaun, rwc
Menu, MyMenu, Add,
...
Menu, MyMenu, Add,
Menu, MyMenu, Add, Open RO's (2000), OPENROS
Menu, MyMenu, Add, HY Used Car Stock (4000), HYUSEDSTOCK
Menu, MyMenu, Add, KI Used Car Stock (4000), KIUSEDSTOCK
Menu, MyMenu, Add, IA Used Car Stock (4000), IAUSEDSTOCK
...
OPENROS:
    ExportOnly("/SHAUN-OPEN-RO", "SHAUN-OPEN-RO Data.csv")
return
HYUSEDSTOCK:
    ExportOnly("/01B-HYUNDAI-USED-CAR-STOCK", "01B-HYUNDAI-USED-CAR-STOCK Data.csv")
return
KIUSEDSTOCK:
    ExportOnly("/05F-KIA-USED-CAR-STOCK", "05F-KIA-USED-CAR-STOCK Data.csv")
return
IAUSEDSTOCK:
    ExportOnly("/05K-ISUZU-USED-CAR-STOCK", "05K-ISUZU-USED-CAR-STOCK Data.csv")
return
...
rwc:
    ExportAndUpload("/04R-ROADWORTHY-VEHICLE-UPLOAD", "04R-ROADWORTHY-VEHICLE-UPLOAD Data.csv")
return
...
ExportOnly(eraQuery, csvName) {
    ...
    WinWaitActive, File Import Monitor,, 80
    if !ErrorLevel
        WinWaitNotActive, File Import Monitor,, 120
    ...
    MsgBox, 64, Done!, Export complete!`n%csvName%`n%csvFile%
    WinActivate, ERA
    Sleep, 200
    Send,{F1}
    return true
